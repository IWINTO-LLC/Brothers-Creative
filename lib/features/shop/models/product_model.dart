...
import 'package:brothers_creative/features/shop/models/product_atribute_model.dart';
import 'package:brothers_creative/features/shop/models/product_variation_model.dart';
import 'package:brothers_creative/utils/logging/logger.dart';
...
class ProductModel {
  ...
  factory ProductModel.fromSnapshot(
    ...
    return ProductModel(
      ...
      brand: data['Brand'] != null ? BrandModel.fromJason(data['Brand']) : null,
  ...
  factory ProductModel.fromJson(Map<String, dynamic> data) {
    return ProductModel(
      ...
      stock: data['Stock'] ?? 0,
      productAtributes:
          data['ProductAtributes'] != null
              ? (data['ProductAtributes'] as List)
                  .map((e) => ProductAtributeModel.fromJason(e))
                  .toList()
              : [],
      productVariations:
